...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/Banuba/BanubaUtilities-iOS.git", .exact("1.23.1")),
    ...
    .package(url: "https://github.com/Banuba/BanubaAudioBrowserSDK-iOS.git", .exact("1.23.1")),
