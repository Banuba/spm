...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/Banuba/BanubaVideoEditorSDK-iOS.git", .exact("1.19.1")),
    .package(url: "https://github.com/Banuba/BanubaMusicEditorSDK-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaSDKServicing-iOS.git", .exact("1.19.1")),
    .package(url: "https://github.com/Banuba/BanubaUtilities-iOS.git", .exact("1.19.1")),
    ...
    .package(url: "https://github.com/Banuba/BanubaSDK-iOS.git", .exact("1.19.1")),
    .package(url: "https://github.com/Banuba/BanubaSDKSimple-IOS.git", .exact("1.19.1")),
