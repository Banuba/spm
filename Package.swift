...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/Banuba/BNBLicenseUtils-iOS.git", .exact("1.20.1")),
    .package(url: "https://github.com/Banuba/VideoEditor-iOS.git", .exact("1.20.1")),
    .package(url: "https://github.com/Banuba/BanubaSDK-iOS.git", .exact("1.20.1")),
    .package(url: "https://github.com/Banuba/BanubaSDKSimple-IOS.git", .exact("1.20.1")),
    .package(url: "https://github.com/Banuba/BanubaARCloudSDK-IOS.git", .exact("1.20.1")),
    .package(url: "https://github.com/Banuba/BanubaEffectPlayer-iOS.git", .exact("1.20.0")),
    .package(url: "https://github.com/Banuba/BanubaAudioBrowserSDK-iOS.git", .exact("1.20.1")),
    .package(url: "https://github.com/Banuba/BanubaTokenStorageSDK-iOS.git", .exact("1.20.1")),
    .package(url: "https://github.com/Banuba/BanubaVideoEditorGallerySDK.git", .exact("1.20.1")),
    .package(url: "https://github.com/Banuba/BanubaVideoEditorTrimSDK-iOS.git", .exact("1.20.1"))
  ],
  targets: [
    .target(
      name: "BanubaMusicEditorSDKPackage",
