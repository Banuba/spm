...
let package = Package(
  ...
  products: [
    .library(
      ...
      .library(
        name: "BanubaVideoEditorEffectsSDKPackage",
        targets: ["BanubaVideoEditorEffectsSDKPackage"]),
  ...
  dependencies: [
    .package(url: "https://github.com/Banuba/BanubaVideoEditorEffectsSDK-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaOverlayEditorSDK-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaLicenseServicingSDK.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaVideoEditorSDK-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaMusicEditorSDK-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaSDKServicing-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaUtilities-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BNBLicenseUtils-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/VideoEditor-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaSDK-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaSDKSimple-IOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaARCloudSDK-IOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaEffectPlayer-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaAudioBrowserSDK-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaTokenStorageSDK-iOS.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaVideoEditorGallerySDK.git", .exact("1.19.0")),
    .package(url: "https://github.com/Banuba/BanubaVideoEditorTrimSDK-iOS.git", .exact("1.20.0"))
  ],
  targets: [
    .target(
      name: "BanubaMusicEditorSDKPackage",
